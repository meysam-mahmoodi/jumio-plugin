...
interface NetverifyAppearance extends NSObjectProtocol {
}
declare var NetverifyAppearance: {

	prototype: NetverifyAppearance;

	netverifyAppearance(): NetverifyAppearance;
};

declare class NetverifyBaseView extends UIView implements NetverifyAppearance {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): NetverifyBaseView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): NetverifyBaseView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): NetverifyBaseView; // inherited from UIAppearance

	static netverifyAppearance(): NetverifyBaseView;
...
declare class NetverifyConfirmationImageView extends UIView {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): NetverifyConfirmationImageView; // inherited from UIAppearance
	...
	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): NetverifyConfirmationImageView; // inherited from UIAppearance
...
interface NetverifyCustomScanViewControllerDelegate extends NSObjectProtocol {
	...
	netverifyCustomScanViewControllerShouldDisplayConfirmationWithImageViewTextConfirmationRetake(customScanView: NetverifyCustomScanViewController, view: NetverifyConfirmationImageView, text: string, confirmation: () => void, retake: () => void): void;

	netverifyCustomScanViewControllerShouldDisplayFlipDocumentHintConfirmation(customScanView: NetverifyCustomScanViewController, message: string, confirmation: () => void): void;
...
declare class NetverifyDocumentSelectionButton extends UIButton implements NetverifyAppearance {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): NetverifyDocumentSelectionButton; // inherited from UIAppearance
	...
	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): NetverifyDocumentSelectionButton; // inherited from UIAppearance

	static buttonWithType(buttonType: UIButtonType): NetverifyDocumentSelectionButton; // inherited from UIButton

	static netverifyAppearance(): NetverifyDocumentSelectionButton;
...
declare class NetverifyDocumentSelectionHeaderView extends UIView implements NetverifyAppearance {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): NetverifyDocumentSelectionHeaderView; // inherited from UIAppearance
	...
	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): NetverifyDocumentSelectionHeaderView; // inherited from UIAppearance

	static netverifyAppearance(): NetverifyDocumentSelectionHeaderView;
...
declare class NetverifyFallbackButton extends UIButton implements NetverifyAppearance {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): NetverifyFallbackButton; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): NetverifyFallbackButton; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): NetverifyFallbackButton; // inherited from UIAppearance

	static buttonWithType(buttonType: UIButtonType): NetverifyFallbackButton; // inherited from UIButton

	static netverifyAppearance(): NetverifyFallbackButton;
...
declare class NetverifyNavigationBarTitleImageView extends UIImageView implements NetverifyAppearance {

	static alloc(): NetverifyNavigationBarTitleImageView; // inherited from NSObject

	static appearance(): NetverifyNavigationBarTitleImageView; // inherited from UIAppearance

	static appearanceForTraitCollection(trait: UITraitCollection): NetverifyNavigationBarTitleImageView; // inherited from UIAppearance

	static appearanceForTraitCollectionWhenContainedIn(trait: UITraitCollection, ContainerClass: typeof NSObject): NetverifyNavigationBarTitleImageView; // inherited from UIAppearance

	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): NetverifyNavigationBarTitleImageView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): NetverifyNavigationBarTitleImageView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): NetverifyNavigationBarTitleImageView; // inherited from UIAppearance

	static netverifyAppearance(): NetverifyNavigationBarTitleImageView;

	static new(): NetverifyNavigationBarTitleImageView; // inherited from NSObject
...
declare class NetverifyNegativeButton extends UIButton implements NetverifyAppearance {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): NetverifyNegativeButton; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): NetverifyNegativeButton; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): NetverifyNegativeButton; // inherited from UIAppearance

	static buttonWithType(buttonType: UIButtonType): NetverifyNegativeButton; // inherited from UIButton

	static netverifyAppearance(): NetverifyNegativeButton;
...
declare class NetverifyPositiveButton extends UIButton implements NetverifyAppearance {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): NetverifyPositiveButton; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): NetverifyPositiveButton; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): NetverifyPositiveButton; // inherited from UIAppearance

	static buttonWithType(buttonType: UIButtonType): NetverifyPositiveButton; // inherited from UIButton

	static netverifyAppearance(): NetverifyPositiveButton;
...
declare class NetverifyScanOverlayView extends UIView implements NetverifyAppearance {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): NetverifyScanOverlayView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): NetverifyScanOverlayView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): NetverifyScanOverlayView; // inherited from UIAppearance

	static netverifyAppearance(): NetverifyScanOverlayView;
...
interface NetverifyUIControllerDelegate extends NSObjectProtocol {
	...
	netverifyUIControllerDidDetermineAvailableCountriesSuggestedCountry(netverifyUIController: NetverifyUIController, countries: NSArray<any>, country: NetverifyCountry): void;
...
declare class NetverifyViewController extends JMNavigationController {
	...
	updateConfiguration(configuration: NetverifyConfiguration): boolean;
}
